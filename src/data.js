// Central demo data used to populate screens without requiring backend access.
export const uiScreens = [
  {
    ...
    items: [
      ...
      [
        "register",
        "Registration",
        "Password confirmation and NID verification",
      ],
  ...
  },
  {
    ...
    items: [
      [
        "citizen-dashboard",
        "Citizen Dashboard",
        "Complaint overview and recent activity",
      ],
      [
        "submit-complaint",
        "Submit Complaint",
        "Waste, waterlogging and emergency reporting",
      ],
      [
        "location",
        "Location Selection",
        "Interactive map and 5 km service check",
      ],
      [
        "submission-confirmation",
        "Submission Confirmation",
        "Unique complaint ID and next steps",
      ],
  ...
  },
  {
    ...
    items: [
      ...
      [
        "admin-profile",
        "Admin Profile",
        "Administrator details and account editing",
      ],
      [
        "manage-complaints",
        "Manage Complaints",
        "Search, filter and open complaints",
      ],
      ...
      [
        "point-degradation",
        "Point Degradation",
        "Review and confirm point deduction",
      ],
    ],
  },
];
...
export const usersSeed = [
  ...
  {
    id: "USR-1036",
    name: "Demo Officer One",
    contact: "demo-phone-01",
    type: "Service Officer",
    joined: "11 Aug 2026",
    status: "Active",
    verified: true,
  },
  {
    ...
    contact: "citizen.two@example.test",
    type: "Citizen",
    joined: "03 Aug 2026",
    status: "Inactive",
    verified: false,
  ...
  {
    id: "USR-1017",
    name: "Demo Citizen Three",
    contact: "demo-phone-02",
    type: "Citizen",
    joined: "24 Jul 2026",
    status: "Active",
    verified: true,
  ...
  {
    id: "USR-1008",
    name: "Demo Officer Two",
    contact: "officer.two@example.test",
    type: "Service Officer",
    joined: "14 Jul 2026",
    status: "Active",
    verified: true,
...
export const notificationsSeed = [
  {
    ...
    message: "CC-24091 has been assigned to the North Zone response team.",
    time: "12 minutes ago",
    unread: true,
    tone: "blue",
  },
  {
    ...
    message: "Your waterlogging complaint passed the initial validity review.",
    time: "1 hour ago",
    unread: true,
    tone: "green",
  },
  {
    ...
    message: "CC-24072 has been marked as resolved.",
  ...
  },
  {
    ...
    message: "The tagged location is inside the CleanCity service area.",
